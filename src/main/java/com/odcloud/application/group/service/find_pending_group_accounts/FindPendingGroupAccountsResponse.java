...
public record FindPendingGroupAccountsResponse(
    List<GroupPendingAccounts> groups
) {

    public static FindPendingGroupAccountsResponse of(
        ...
        return new FindPendingGroupAccountsResponse(groupPendingAccountsList);
    }
