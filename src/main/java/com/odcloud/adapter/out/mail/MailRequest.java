...
public record MailRequest(
    ...
    public static MailRequest ofGroupAccountStatusApproved(String groupId, String accountName,
        String accountEmail, String status) {
        return MailRequest.builder()
            .from("오디 클라우드 지원팀 <akkessun@gmail.com>")
            ...
            .contents(String.format("<!DOCTYPE html>\n"
                ...
                + "      <p style=\"font-size: 15px; color: #444; line-height: 1.6;\">\n"
                + "        안녕하세요, %s님!<br />\n"
                + "        <b>%s</b> 그룹의 가입 상태가 <b>%s</b>(으)로 변경되었습니다.<br />\n"
                ...
                + "    </div>\n"
                + "  </body>\n"
                + "</html>\n", accountName, groupId, status))
            .toList(List.of(accountEmail))
            .fileList(List.of())
            .build();
    }
