...
class FolderTest {
    ...
    class Describe_builder {
        ...
        @Test
        @DisplayName("[success] Builder로 Folder를 생성한다")
        void success() {
            // given
        ...
        @Test
        @DisplayName("[success] null 값으로 Folder를 생성한다")
        void success_nullValues() {
            ...
            assertThat(folder.getPath()).isNull();
            assertThat(folder.getAccessLevel()).isNull();
            assertThat(folder.getModDt()).isNull();
            assertThat(folder.getRegDt()).isNull();
        }

        @Test
        @DisplayName("[success] parentId를 가진 Folder를 생성한다")
        void success_withParentId() {
            // when
            Folder folder = Folder.builder()
                .id(2L)
                .parentId(1L)
    ...
    class Describe_createSubFolder {
        ...
        void success_rootPath() {
            ...
            assertThat(folder.getPath().split("/")).hasSize(2);
        }
