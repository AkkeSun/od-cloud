...
class FileTest {
    ...
    class Describe_builder {
        ...
        @Test
        @DisplayName("[success] Builder로 File을 생성한다")
        void success() {
            // given
        ...
        @Test
        @DisplayName("[success] null 값으로 File을 생성한다")
        void success_nullValues() {
            ...
            assertThat(file.getFileLoc()).isNull();
            assertThat(file.getMultipartFile()).isNull();
            assertThat(file.getModDt()).isNull();
            assertThat(file.getRegDt()).isNull();
        }

        @Test
        @DisplayName("[success] 빈 문자열로 File을 생성한다")
        void success_emptyStrings() {
            ...
            assertThat(file.getFileLoc()).isEmpty();
        }
    }
