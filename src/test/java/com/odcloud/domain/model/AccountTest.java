...
class AccountTest {
    ...
    class Describe_builder {
        ...
        @Test
        @DisplayName("[success] Builder로 Account를 생성한다")
        void success() {
            // given
        ...
        @Test
        @DisplayName("[success] null 값으로 Account를 생성한다")
        void success_nullValues() {
            ...
            assertThat(account.getPicture()).isNull();
            assertThat(account.getGroups()).isNull();
            assertThat(account.getModDt()).isNull();
            assertThat(account.getRegDt()).isNull();
        }

        @Test
        @DisplayName("[success] 빈 리스트로 Account를 생성한다")
    ...
    class Describe_of_fromGoogleUserInfo {
        ...
        @Test
        @DisplayName("[success] null 값을 포함한 GoogleUserInfoResponse로부터 Account를 생성한다")
        void success_nullValues() {
            // given
            GoogleUserInfoResponse userInfo = new GoogleUserInfoResponse(
                null,
            ...
            assertThat(account.getPicture()).isNull();
            assertThat(account.getGroups()).hasSize(1);
            assertThat(account.getGroups().get(0).getId()).isNull();
        }
    }
