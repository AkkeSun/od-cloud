package com.odcloud.adapter.in.controller.reissue_token;
...
class ReissueTokenResponseTest {
    ...
    class Describe_of {
        ...
        void success() {
            ...
            // when
            ReissueTokenResponse response = ReissueTokenResponse.of(serviceResponse);

            // then
            assertThat(response).isNotNull();
            assertThat(response.accessToken()).isEqualTo("new-access-token-123");
            assertThat(response.refreshToken()).isEqualTo("new-refresh-token-456");
        }
    ...
    class Describe_immutability {
        ...
        void success() {
            // given
            ReissueTokenResponse response1 = ReissueTokenResponse.builder()
                .accessToken("new-access-token-123")
                .refreshToken("new-refresh-token-456")
                .build();

            ReissueTokenResponse response2 = ReissueTokenResponse.builder()
                .accessToken("new-access-token-123")
                .refreshToken("new-refresh-token-456")
                .build();
