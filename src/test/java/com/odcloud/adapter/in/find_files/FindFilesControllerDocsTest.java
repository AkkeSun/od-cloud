...
class FindFilesControllerDocsTest extends RestDocsSupport {
            ...
            .andDo(document(String.format("[%s] %s", apiName, identifier),
                    ...
                    resource(ResourceSnippetParameters.builder()
                        ...
                        .queryParameters(
                            ...
                            parameterWithName("sortType").description("정렬 타입 (NAME_ASC / NAME_DESC / REG_DT_ASC / REG_DT_DESC)").optional()
                        )
    ...
    private void performErrorDocument(
        ...
        performDocument(identifier, "error", authorization, folderId, groupId, keyword, sortType, status,
