    ...
    class Describe_save {
        ...
        void success() {
            ...
            FileEntity savedEntity = entityManager
                .createQuery("SELECT f FROM FileEntity f WHERE f.folderId = :folderId", FileEntity.class)
        ...
        void success_variousExtensions() {
            ...
            // then
            var savedFiles = entityManager
                .createQuery("SELECT f FROM FileEntity f WHERE f.folderId = :folderId ORDER BY f.fileName", FileEntity.class)
                .setParameter("folderId", folder.getId())
                .getResultList();
