    ...
    class Describe_register {
        ...
        void success() {
            ...
            var savedLogs = entityManager
                .createQuery("SELECT a FROM ApiCallLogEntity a WHERE a.apiId = :apiId", ApiCallLogEntity.class)
        ...
        void success_multipleLogs() {
            ...
            // then
            var savedLogs = entityManager
                .createQuery("SELECT a FROM ApiCallLogEntity a ORDER BY a.regDt", ApiCallLogEntity.class)
                .getResultList();
        ...
        void success_variousHttpStatus() {
            ...
            // then
            var savedLogs = entityManager
                .createQuery("SELECT a FROM ApiCallLogEntity a ORDER BY a.apiId", ApiCallLogEntity.class)
                .getResultList();
        ...
        void success_sameApiMultipleTimes() {
            ...
            // then
            var savedLogs = entityManager
                .createQuery("SELECT a FROM ApiCallLogEntity a WHERE a.apiId = :apiId ORDER BY a.regDt", ApiCallLogEntity.class)
                .setParameter("apiId", 1L)
                .getResultList();
