...
class FindGroupAccountListServiceResponseTest {
    ...
    class Describe_constructor {
        ...
        void success() {
            ...
            // when
            FindGroupAccountListServiceResponse response = new FindGroupAccountListServiceResponse(groupAccounts);
        ...
        void success_nullValue() {
            // when
            FindGroupAccountListServiceResponse response = new FindGroupAccountListServiceResponse(null);
    ...
    class Describe_of {
        ...
        void success() {
            ...
            // when
            FindGroupAccountListServiceResponse response = FindGroupAccountListServiceResponse.of(groupAccounts);
        ...
        void success_null() {
            // when
            FindGroupAccountListServiceResponse response = FindGroupAccountListServiceResponse.of(null);
    ...
    class Describe_immutability {
        ...
        void success() {
            ...
            FindGroupAccountListServiceResponse response1 = new FindGroupAccountListServiceResponse(groupAccounts);
            FindGroupAccountListServiceResponse response2 = new FindGroupAccountListServiceResponse(groupAccounts);
        ...
        void success_notEqual() {
            ...
            FindGroupAccountListServiceResponse response1 = new FindGroupAccountListServiceResponse(groupAccounts1);
            FindGroupAccountListServiceResponse response2 = new FindGroupAccountListServiceResponse(groupAccounts2);
