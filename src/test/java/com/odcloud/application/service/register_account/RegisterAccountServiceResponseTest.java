...
class RegisterAccountServiceResponseTest {
    ...
    class Describe_constructor {
        ...
        void success() {
            // when
            RegisterAccountServiceResponse response = new RegisterAccountServiceResponse(Boolean.TRUE);
        ...
        void success_false() {
            // when
            RegisterAccountServiceResponse response = new RegisterAccountServiceResponse(Boolean.FALSE);
    ...
    class Describe_immutability {
        ...
        void success() {
            // given
            RegisterAccountServiceResponse response1 = new RegisterAccountServiceResponse(Boolean.TRUE);
            RegisterAccountServiceResponse response2 = new RegisterAccountServiceResponse(Boolean.TRUE);
        ...
        void success_notEqual() {
            // given
            RegisterAccountServiceResponse response1 = new RegisterAccountServiceResponse(Boolean.TRUE);
            RegisterAccountServiceResponse response2 = new RegisterAccountServiceResponse(Boolean.FALSE);
