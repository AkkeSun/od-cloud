...
class UpdateGroupAccountStatusResponseTest {
    ...
    class Describe_constructor {
        ...
        @Test
        @DisplayName("[success] Constructor로 UpdateGroupAccountStatusResponse를 생성한다")
        void success() {
            // when
            UpdateGroupAccountStatusResponse response = new UpdateGroupAccountStatusResponse(
                Boolean.TRUE);
        ...
        @Test
        @DisplayName("[success] false 값으로 Constructor로 UpdateGroupAccountStatusResponse를 생성한다")
        void success_false() {
            // when
            UpdateGroupAccountStatusResponse response = new UpdateGroupAccountStatusResponse(
                Boolean.FALSE);
        ...
        @Test
        @DisplayName("[success] null 값으로 Constructor로 UpdateGroupAccountStatusResponse를 생성한다")
    ...
    class Describe_ofSuccess {
        ...
        void success() {
            // when
            UpdateGroupAccountStatusResponse response = UpdateGroupAccountStatusResponse.ofSuccess();
    ...
    class Describe_immutability {
        ...
        @Test
        @DisplayName("[success] UpdateGroupAccountStatusResponse는 불변 객체이다")
        void success() {
            // given
        ...
        @Test
        @DisplayName("[success] 다른 값으로 생성된 UpdateGroupAccountStatusResponse는 동등하지 않다")
