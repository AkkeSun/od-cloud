...
class CancelDowngradeReservationCommandTest {

    @Nested
    @DisplayName("[builder] CancelDowngradeReservationCommand를 생성하는 빌더")
    class Describe_builder {
        ...
        void success() {
            ...
            // when
            CancelDowngradeReservationCommand command = CancelDowngradeReservationCommand.builder()
                .subscriptionId(10L)
                .account(account)
                .build();
