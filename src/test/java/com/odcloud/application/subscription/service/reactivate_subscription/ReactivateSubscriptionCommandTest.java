...
class ReactivateSubscriptionCommandTest {

    @Nested
    @DisplayName("[builder] ReactivateSubscriptionCommand를 생성하는 빌더")
    class Describe_builder {
        ...
        void success() {
            ...
            // when
            ReactivateSubscriptionCommand command = ReactivateSubscriptionCommand.builder()
                .subscriptionId(10L)
                .account(account)
                .build();
