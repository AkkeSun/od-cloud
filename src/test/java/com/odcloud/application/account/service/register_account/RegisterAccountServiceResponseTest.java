...
class RegisterAccountResponseTest {
    ...
    class Describe_constructor {
        ...
        @Test
        @DisplayName("[success] Constructor로 RegisterAccountResponse를 생성한다")
        void success() {
            // when
        ...
        @Test
        @DisplayName("[success] false 값으로 Constructor로 RegisterAccountResponse를 생성한다")
        void success_false() {
            // when
            RegisterAccountResponse response = new RegisterAccountResponse(
                Boolean.FALSE);
        ...
        @Test
        @DisplayName("[success] null 값으로 Constructor로 RegisterAccountResponse를 생성한다")
    ...
    class Describe_ofSuccess {
        ...
        void success() {
            // when
            RegisterAccountResponse response = RegisterAccountResponse.ofSuccess();
    ...
    class Describe_immutability {
        ...
        @Test
        @DisplayName("[success] RegisterAccountResponse는 불변 객체이다")
        void success() {
            // given
            RegisterAccountResponse response1 = new RegisterAccountResponse(
                Boolean.TRUE);
            RegisterAccountResponse response2 = new RegisterAccountResponse(
                Boolean.TRUE);
        ...
        @Test
        @DisplayName("[success] 다른 값으로 생성된 RegisterAccountResponse는 동등하지 않다")
