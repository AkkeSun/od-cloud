...
public class FakeFolderStoragePort implements FolderStoragePort {
    ...
    public void save(Folder folder) {
        ...
        log.info("FakeFolderStoragePort saved folder: id={}, name={}", savedFolder.getId(), savedFolder.getName());
    }
    ...
    public Folder findById(Long id) {
        return database.stream()
            ...
            .findFirst()
            .orElseThrow(() -> new CustomBusinessException(ErrorCode.Business_DoesNotExists_FOLDER));
    }
